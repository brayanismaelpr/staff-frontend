                ...
                <div className="min-w-screen min-h-screen flex justify-center bg-gray-50 font-sans overflow-hidden">
                    <div className="w-full lg:w-5/6">
                        ...
                        <div className="md:flex flex-wrap items-center mt-8">
                            <div className="mr-2">
                                <p class="font-medium">Cuerpo técnico</p>
                            ...
                            <div className="ml-2">
                                <div className="relative">
                                <label class="font-medium">Integrante:</label>
                                <input className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" list="browsers" name="myBrowser" />
                                    ...
                                    <tr className="border-b border-gray-200 hover:bg-gray-100">
                                        <td className="py-3 px-6 text-left whitespace-nowrap">
                                            <div className="flex items-center">
                                                <span className="font-medium">Brayan Ismael</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6 text-left">
                                            <div className="flex items-center">
                                                <span className="font-medium">Peñaranda Rincón</span>
                                            </div>
                                        </td>
                                        <td className="py-3 px-6 text-center">
                                            <span className="font-medium bg-purple-200 text-purple-600 py-1 px-3 rounded-full text-xs">
                                                brayanismaelpr@ufps.edu.co
                      </span>
                                        </td>
                                        <td className="py-3 px-6 text-center">
                                            <span className="font-medium">3157437307</span>
                                        </td>
                                        <td className="py-3 px-6 text-center">
                                            <p className="font-medium">21/05/2021</p>
                                        </td>
                                        <td className="py-3 px-6 text-center">
                                            <a href="#">
